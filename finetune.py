...
def get_config(data_dir: str):
    ...
    if config['task_name'] == 'BBBP':
        ...
        config['dataset']['data_path'] = f'{data_dir}bbbp.csv'
        target_list = ["p_np"]

    elif config['task_name'] == 'Tox21':
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = f'{data_dir}tox21.csv'
        target_list = [
        ...
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = f'{data_dir}clintox.csv'
        target_list = ['CT_TOX', 'FDA_APPROVED']

    elif config['task_name'] == 'HIV':
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = f'{data_dir}hiv.csv'
        target_list = ["HIV_active"]

    elif config['task_name'] == 'BACE':
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = f'{data_dir}bace.csv'
        target_list = ["Class"]

    elif config['task_name'] == 'SIDER':
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = f'{data_dir}sider.csv'
        target_list = [
        ...
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = f'{data_dir}muv.csv'
        target_list = [
        ...
        config['dataset']['data_path'] = f'{data_dir}freesolv.csv'
        target_list = ["expt"]
        ...
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = f'{data_dir}lipophilicity.csv'
        target_list = ["exp"]

    elif config["task_name"] == 'qm7':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = f'{data_dir}qm7.csv'
        target_list = ["u0_atom"]

    elif config["task_name"] == 'qm8':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = f'{data_dir}qm8.csv'
        target_list = [
